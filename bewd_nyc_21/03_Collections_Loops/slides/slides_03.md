...
###Setting Values
	...
	user_hash = {}
	user_hash["name"] = "Brian"
	user_hash["favorite_color"] = "Green"
	user_hash

	>> {"name"=>"Brian", "favorite_color"=>"Green"}
...
###Methods
	...
	user = {:user_name => "BrianFountain", :email => "brian@brianfountain.com"}

	user.has_key? :email #true
	user.key? :email #true
	user.include? :email #true

	user.has_value? "BrianFountain" #true (note: extremely inefficient!)
...
###Ruby 1.9+ Alternate Syntax
	...
	user = {user: "BrianFountain", email: "brian@brianfountain.com"}
...
###Array of Hashes
	...
	users = [
		{:user => "Brian Fountain", :role => "Instructor"},
		{:user => "Nick Blanchet", :role=> "Expert-in-Residence"}
		{:user => "Zach Ramey", :role => "Student"]
	]
